...
function ListaDeParticipacoesPage() {
    ...
    return (
        <>
            ...
            <TabelaDeParticipacoes onRemoveParticipacao={handleRemovedParticipacao}
                                   onAlteraParticipacao={handleAlteraParticipacao} participacoes={participacoes}/>
            <Paginacao
                pagina={pagina}
...
export default ListaDeParticipacoesPage;
